...
starturl = 'http://www.eciresults.nic.in/ConstituencywiseS26'
...
res = requests.get('http://eciresults.nic.in/ConstituencywiseS2610.htm?ac=10', headers=headers)
...
cons = soup.find_all('input',{"id":"HdnCG"}) #Goa constituency list
...
#filename = input()
cresults.to_csv('chhattisgarh.csv', na_rep='.') 
