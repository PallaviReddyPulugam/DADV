...
starturl = 'http://www.eciresults.nic.in/ConstituencywiseS29'
#headers = {'user-agent': 'Intel_Windows 10; C:\Users\user\visual'} # It's nice to say who you are

#Get constituency list and numbers
res = requests.get('http://eciresults.nic.in/ConstituencywiseS2982.htm?ac=82') # , headers=headers)
...
cons = soup.find_all('input',{"id":"HdnTG"}) #TG constituency list
...
#filename = input()
cresults.to_csv('telangana.csv', na_rep='.') 
