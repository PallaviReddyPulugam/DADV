...
starturl = 'http://www.eciresults.nic.in/ConstituencywiseS20'
...
res = requests.get('http://eciresults.nic.in/ConstituencywiseS2053.htm?ac=53', headers=headers)
...
cons = soup.find_all('input',{"id":"HdnRJ"}) #RJ constituency list
...
#filename = input()
cresults.to_csv('rajasthan.csv', na_rep='.') 
