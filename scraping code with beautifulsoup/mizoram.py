...
starturl = 'http://www.eciresults.nic.in/ConstituencywiseS16'
...
res = requests.get('http://eciresults.nic.in/ConstituencywiseS1610.htm?ac=10', headers=headers)
...
cons = soup.find_all('input',{"id":"HdnMZ"}) #MZ constituency list
...
#filename = input()
cresults.to_csv('mizoram.csv', na_rep='.') 
